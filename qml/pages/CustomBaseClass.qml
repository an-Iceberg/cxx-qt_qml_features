...
Page
{
  ...
  header: ToolBar
  {
    RowLayout
    {
      ...
      Label { text: qsTr("Count: %1").arg(root.activeListView.count) }
    }
  }
  ...
  ColumnLayout
  {
    ...
    TabBar
    {
      ...
      TabButton { text: qsTr("Default Model") }
      TabButton { text: qsTr("Shorter Delay") }
    }
    ...
    StackLayout
    {
      ...
      ScrollView
      {
        ...
        ListView
        {
          ...
          model: CustomBaseClass { id: customBaseClass }
      ...
      ScrollView
      {
        ...
        ListView
        {
          ...
          model: TransitiveInheritance { id: transitiveInheritance }
